...
@WebServlet("/reports/top-gasto")
public class TopGastoServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        var data = dao.topClientesMayorGasto(limit);
        req.setAttribute("data", data);
        req.setAttribute("title", "Top clientes que más gastaron");
